...
Minimap.prototype = Object.assign({}, mapboxgl.NavigationControl.prototype, {
	...
	options: {
		...
		width: "384px",
		height: "100px",
		style: "mapbox://styles/kikistef/ckui30mvj7frn18qj94fmcyty",
		center: [0, 0],
		zoom: 8,
	...
	_load: function ()
	{
		...
		miniMap.on("mousewheel", this._mousewheel.bind(this));
	...
	_createContainer: function ( parentMap )
	{
		...
		container.className = "mapboxgl-ctrl-minimap mapboxgl-ctrl positionY0";
